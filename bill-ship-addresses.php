...
<div class="body-content outer-top-bd" style=" background-color:#b3e0ff;">
	<div class="container">
			...
			<div class="row">
				<div class="col-md-8">
					<div class="panel-group checkout-steps" id="accordion">
						<!-- checkout-step-01  -->
<div class="panel panel-default checkout-step-01"style=" background-color:#ffffcc">
...
<!-- checkout-step-01  -->
					    <!-- checkout-step-02  -->
					  	<div class="panel panel-default checkout-step-02" style=" background-color:#ffccff">
						    <div class="panel-heading">
						      <h4 class="unicase-checkout-title">
