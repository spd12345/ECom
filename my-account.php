...
<div class="body-content outer-top-bd" style=" background-color:#b3cccc;">
	<div class="container" style=" background-color:#ffece6;">
		<div class="checkout-box inner-bottom-sm" >
			<div class="row" >
				<div class="col-md-8" >
					<div class="panel-group checkout-steps" id="accordion" style=" background-color:red;">
						<!-- checkout-step-01  -->
<div class="panel panel-default checkout-step-01" style=" background-color:#d1b3ff;">

	<!-- panel-heading -->
		<div class="panel-heading" style=" background-color:#b3e0ff;">
    	<h4 class="unicase-checkout-title">
	        <a data-toggle="collapse" class="" data-parent="#accordion" href="#collapseOne">
	          <span>1</span>My Personal Profile
	        </a>
	     </h4>
    </div>
    <!-- panel-heading -->
...
<div class="form-group"  >
			 ...
			 <input type="email" class="form-control unicase-form-control text-input" id="exampleInputEmail1" value="<?php echo $row['email'];?>" readonly>
					  ...
					  <div class="form-group">
					    <label class="info-title" for="Contact No.">Mobile No. <span>*</span></label>
...
<!-- checkout-step-01  -->
					    <!-- checkout-step-02  -->
					  	<div class="panel panel-default checkout-step-02" style=" background-color:#ffc6b3;">
						    <div class="panel-heading" style=" background-color:#b3e0ff;">
						      <h4 class="unicase-checkout-title">
			 ...
			 <input type="password" class="form-control unicase-form-control text-input" id="newpass" name="newpass">
					  ...
					  <button type="submit" name="submit" class="btn-upper btn btn-primary checkout-page-button" style=" background-color:red;">Change </button>
					</form>
