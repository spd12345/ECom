...
$_SESSION['errmsg']="Your Password Successfully  Changed. ";
exit();
}
else
{
...
$uri  = rtrim(dirname($_SERVER['PHP_SELF']),'/\\');
header("location:http://$host$uri/$extra");
$_SESSION['errmsg']="Invalid Email Address or Mobile No. ";
exit();
}
}
...
<div class="col-md-6 col-sm-6 sign-in">
	<h4 style="color:red;">Forgot password change form</h4>
...
?>
		...
		<div class="form-group">
		 ...
		 <input type="number" name="contact" class="form-control unicase-form-control text-input" id="contact" required>
		</div>
        <div class="form-group">
