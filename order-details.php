...
<div class="body-content outer-top-xs">
	...
	<div class="table-responsive" style=" background-color:#eeeee6;">
<form name="cart" method="post">

		<table class="table table-bordered">
			<thead>
				<tr>
					<th class="cart-romove item">Sl.No</th>
					...
					<th class="cart-total item">Payment Mode</th>
...
?>
 ...
 <a href="javascript:void(0);" onClick="popUpWindow('track-order.php?oid=<?php echo htmlentities($row['orderid']);?>');" title="Track order">
					<font color="blue" size="3" >Tracking </td>
				</tr>
<?php $cnt=$cnt+1;} } else { ?>
