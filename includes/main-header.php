		...
		<ul class="dropdown-menu">
			...
			<li>
				<div class="cart-item product-summary">
					<div class="row">
						<div class="col-xs-12">
							<h6 style="color:blue;"> Your Shopping Cart is Empty.</h6>
						</div>
			...
			<div class="clearfix cart-total">
				...
				<a href="index.php" class="btn btn-upper btn-primary btn-block m-t-20" style="background-color:blue;">Continue Shooping</a>
			</div><!-- /.cart-total-->
