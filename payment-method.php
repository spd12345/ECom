...
<div class="panel panel-default checkout-step-01">
	...
	<div id="collapseOne" class="panel-collapse collapse in">
		...
		<!-- panel-body  -->
	    <div class="panel-body" style=" background-color:#e6e6ff;">
	    <form name="payment" method="post">
	    <input type="radio" name="paymethod" value="COD" checked="checked"> COD
		<input type="radio" name="paymethod" value="Phone Pay" checked="checked">Phone Pay
	     ...
	     <input type="submit" value="Payment" name="submit" class="btn btn-primary" style=" background-color:red;">
