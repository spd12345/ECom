...
<html lang="en">
	<head>
		...
		<link href="assets/css/black.css" rel="alternate stylesheet" title="Blue color">
...
<div class="body-content outer-top-xs">
	...
	<div class="table-responsive" style=" background-color:#cccccc;" >
...
if(!empty($_SESSION['cart'])){
	?>
		<table class="table table-bordered">
			<thead>
				<tr>
					<th class="cart-romove item">Cancelled</th>
				...
				<tr>
					<td colspan="7">
						<div class="shopping-cart-btn">
							<span class="">
								<a href="index.php" class="btn btn-upper btn-primary outer-left-xs">Shopping Continue</a>
...
</div><!-- /.shopping-cart-table -->			<div class="col-md-4 col-sm-12 estimate-ship-tax" style=" background-color:#ffcce6;">
	<table class="table table-bordered">
		<thead>
			<tr>
				<th>
...
<div class="col-md-4 col-sm-12 estimate-ship-tax" style=" background-color:#f9e6ff;">
	<table class="table table-bordered">
		<thead>
			<tr>
				<th>
				...
				<tr>
					<td>
						<div class="cart-checkout-btn pull-right">
								<button type="submit" name="ordersubmit" class="btn btn-primary">Check and Paid</button>
...
<button type="submit" name="Continue Shopping" style="cursor: pointer;"><a href="index.php">Continue Shopping</a></button>
			<?php }  ?>
		</form>
