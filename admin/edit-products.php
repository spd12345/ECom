			...
			<div class="span9">
					<div class="content">
						...
						<div class="module">
							...
							<h1 style="color:white; background-color:skyblue; text-align:center">Update Product</h3>
							</div>
...
<?php } ?>
	<div class="control-group">
											<div class="controls">
												<button type="submit" name="submit" class="btn" style="background-color:gray;">Change</button>
											</div>
										</div>
									</form>
							</div>
