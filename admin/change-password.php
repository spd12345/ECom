...
if($num>0)
{
 $sql=mysqli_query($con,"update admin set password='".md5($_POST['newpassword'])."', updationDate='$currentTime' where username='".$_SESSION['alogin']."'");
			...
			<div class="span9">
					<div class="content">
						...
						<div class="module">
							...
							<h1 style="color:white; background-color:skyblue; text-align:center">Admin Change Password</h1>
							</div>
