...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr height="50">
      <td colspan="2" class="fontkink2" style="padding-left:0px;"><div class="fontpink2"> <b>Update Order Details</b></div></td>
      ...
      <td  class="fontkink"><span class="fontkink1" >
        <select name="status" class="fontkink" required="required" >
          <option value="">Select Status</option>
                  ...
                  <option value="Deliver on the way">Deliver on the way</option>
...
<form id="myForm" action="track-order.php" method="post" disabled>
  <table>
    <tr>
      <td>
