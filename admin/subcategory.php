			...
			<div class="span9">
					<div class="content">
						...
						<div class="module">
							...
							<h1 style="color:white; background-color:skyblue; text-align:center">New Sub-Category Entry</h1>
							</div>
...
<input type="text" placeholder="Enter SubCategory Name"  name="subcategory" class="span8 tip" required>
	...
	<div class="module">
							<div class="module-head">
								<h1 style="color:white; background-color:skyblue; text-align:center">All Sub Category List</h1>
							</div>
							<div class="module-body table">
								<table style="color:blue;  text-align:center" cellpadding="3" cellspacing="3" border="3" class="datatable-1 table table-bordered table-striped	 display" width="100%">
									<!--thead bgcolor="blue"-->
										<tr >
											<th>Sl.No</th>
											<th>Category</th>
